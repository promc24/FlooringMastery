...
class FlooringDaoImplTest {
    ...
    void testAddOrder() throws FlooringPersistenceException {
        ...
        Order order = new Order(2, "Armin Arlert", "Texas", new BigDecimal("4.45"),
        ...
        assertEquals(order.getOrderNumber(), retrievedOrders.get(1).getOrderNumber());
    }

    //tests get order list
    @Test
    void testGetAllOrders_NoOrders_ReturnsEmptyList() throws FlooringPersistenceException {
        LocalDate orderDate = LocalDate.of(2025, 5, 30);
    ...
    //test order update
    @Test
    void testUpdateOrder_Success() throws FlooringPersistenceException {
        LocalDate orderDate = LocalDate.of(2025, 5, 30);
        Order order = new Order(2, "Armin Arlert", "Texas", new BigDecimal("4.45"),
                "Wood", new BigDecimal("100"), new BigDecimal("5.15"), new BigDecimal("4.75"),
                new BigDecimal("515.00"), new BigDecimal("475.00"), new BigDecimal("39.60"), new BigDecimal("1029.60"));
        ...
        Order updatedOrder = new Order(2, "Eren Jaegar", "CA", new BigDecimal("7.50"),
        ...
        assertEquals("Eren Jaegar", orders.get(1).getCustomerName());
    }

    //test removing order
    @Test
    void testRemoveOrder_Success() throws FlooringPersistenceException {
        LocalDate orderDate = LocalDate.of(2025, 5, 30);
    ...
    void testCalculateOrderInfo() {
        ...
        ArrayList<BigDecimal> results = dao.calculateOrderInfo(tempOrderInfoList);
